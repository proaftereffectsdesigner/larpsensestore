                ...
                <div className="space-y-2">
                  ...
                  <button 
                    ...
                    className={`w-full flex items-center justify-between p-4 border rounded-2xl transition-all ${
                      ...
                      (loadingSettings) ? 'opacity-80 cursor-not-allowed bg-[#141414] border-white/5 animate-pulse' :
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-[11px] text-gray-500 font-medium">{(!settings.stripe_enabled && !loadingSettings) ? 'Temporarily disabled' : loadingSettings ? 'Loading methods...' : 'Mastercard, Visa, Apple Pay etc.'} <span className="text-indigo-400 font-bold">(5% + €0.50 fee)</span></div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-[11px] text-gray-500 font-medium">{(!settings.crypto_enabled && !loadingSettings) ? 'Temporarily disabled' : loadingSettings ? 'Loading methods...' : 'SOL, LTC, USDT'} <span className="text-amber-400 font-bold">(0.5% fee)</span></div>
                        </div>
                      </div>
